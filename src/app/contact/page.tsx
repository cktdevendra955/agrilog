        ...
        <nav className="sticky top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-white/30 shadow-sm">
          <div className="max-w-[1280px] mx-auto px-16 flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-4">
              <button className="px-6 py-2 border border-[#c0c8c3] text-[#414944] text-[14px] font-semibold tracking-[0.05em] rounded-full hover:bg-[#00261a]/5 transition-all">
                Investor Relations
              </button>
              <button className="px-6 py-2 bg-[#00261a] text-white text-[14px] font-semibold tracking-[0.05em] rounded-full border-b-2 border-[#775a19] shadow-md hover:-translate-y-0.5 transition-all">
                Request Quote
              </button>
            </div>
          </div>
