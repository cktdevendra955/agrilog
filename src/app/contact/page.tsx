                ...
                <div className="relative z-10 p-8 md:p-12">
                  ...
                  <div className="mb-10">
                    ...
                    <p className="text-[16px] md:text-[18px] leading-[1.8] text-[#414944] max-w-2xl">
                      Speak directly with our commodity specialists for tailored
                      export solutions, compliance guidance, and global sourcing
                      partnerships.
                    </p>
                  </div>
                  ...
                  {[
                    {
                      ...
                      sub: "Real-time trading support",
                      cta: "Connect",
                    },
                    {
                      icon: "event",
                      bg: "bg-[#fed488]",
                      iconColor: "text-[#785a1a]",
                      title: "Trade Consultation",
                      sub: "Schedule a 15min discovery call",
                      cta: "Book Now",
                    },
                    ...
                    <a
                      key={title}
                      href="#"
                      className="flex items-center gap-4 p-6 bg-[#f3f4f3] rounded-xl border border-[#c0c8c3] hover:border-[#775a19] hover:bg-white transition-all group"
                    >
                      <div
                ...
                <div className="space-y-4">
                  {offices.map(
                    ({
                      ...
                      <div
                        key={title}
                        className={`p-6 glass-panel rounded-[4px] border-l-4 ${borderColor} hover:shadow-md transition-shadow`}
                      >
                        <div className="flex justify-between items-start mb-2">
                          <p className="text-[24px] leading-[1.3] font-semibold text-[#00261a]">
                            {title}
                          </p>
                          {badge && (
                            <span className="px-2 py-0.5 bg-[#00261a]/10 text-[#00261a] text-[10px] font-bold rounded uppercase">
                              {badge}
                            </span>
                          )}
                        </div>
                        <p className="text-[#414944] mb-4 text-sm leading-relaxed">
                          {address}
                        </p>
                        <div className="flex flex-col gap-3 text-sm border-t border-[#c0c8c3]/20 pt-4">
                          <a
                            href={phoneHref}
                            className="flex items-center gap-3 hover:text-[#00261a] transition-colors"
                          >
                            <span
        ...
        <section className="relative overflow-hidden py-28 md:py-36">
          ...
          <div className="relative z-20 max-w-[1280px] mx-auto px-6 md:px-10 lg:px-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Our Global
                <span className="block text-[#ffdea5]">Network Reach</span>
              </h2>
              ...
              <p className="text-[17px] md:text-[20px] leading-[1.9] text-white/75 max-w-3xl mx-auto mb-14">
                Connecting certified organic producers with international
                markets through optimized logistics corridors, precision
                sourcing systems, and sustainable export infrastructure across
                multiple continents.
              </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-12 items-center justify-items-center opacity-70 hover:opacity-100 transition-opacity duration-500">
              {certs.map(({ icon, label, fill }) => (
                ...
                >
                  ...
                  <span className="text-[12px] font-bold text-[#191c1c] tracking-[0.05em]">
                    {label}
                  </span>
                </div>
              ))}
